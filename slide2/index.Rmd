...
include_graphics("figs/rda scaling 1.png")
```
]
...
.pull-right[
```{r, fig.align='center', echo=FALSE, out.width="90%"}
include_graphics("figs/rda scaling 2.png")
```
]
...
include_graphics("figs/rda scaling 3.png")
```
]
...
```{r, fig.align='center', echo=FALSE, out.width="80%"}
include_graphics("figs/rda scaling 0.png")
```
]
