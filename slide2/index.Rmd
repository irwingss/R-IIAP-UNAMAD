...
data("varespec")
data("varechem")
CCA_vare <- cca(varespec ~ Al + K + Baresoil, data = varechem) #<<
CCA_vare
```
...
data("varespec")
data("varechem")
CCA_vare <- cca(varespec ~ Al + P + K + Baresoil, data = varechem) #<<
CCA_vare
```
...
```{r}
permustats(anova(CCA_vare)) |> summary()
```

---

```{r, out.width="90%"}
permustats(anova(CCA_vare)) |> densityplot()
```

---

```{r}
permustats(anova(CCA_vare, by="axis")) |> summary()
```

---

```{r, out.width="90%"}
permustats(anova(CCA_vare, by="axis")) |> densityplot()
```

---
 
```{r}
permustats(anova(CCA_vare, by="terms")) |> summary()
```

---

```{r, out.width="90%"}
permustats(anova(CCA_vare, by="terms")) |> densityplot()
```
