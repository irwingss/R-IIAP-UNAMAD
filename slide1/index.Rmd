...
.panel[.panel-name[Código+regresión]
```{r, eval=FALSE}
# Gráfico con ggplot2
library(tidyverse)
pinguinos %>%
...
.panel[.panel-name[Gráfico+regresión]
```{r, echo=FALSE, out.width="70%", fig.align='center'}
# Gráfico con ggplot2
library(tidyverse)
pinguinos %>%
...
.panel[.panel-name[Código+Variable]
```{r, eval=FALSE}
# Gráfico con ggplot2
library(tidyverse)
pinguinos %>%
...
.panel[.panel-name[Gráfico+Variable]
```{r, echo=FALSE, out.width="70%", fig.align='center'}
# Gráfico con ggplot2
library(tidyverse)
pinguinos %>%
...
.panel[.panel-name[Gráfico ggpairs()]
...
.panelset[
.panel[.panel-name[Var. ambientales]
...
.panel[.panel-name[Abundancias-PCA]
...
.panel[.panel-name[Abundancias-CA]
...
.panel[.panel-name[Abundancias-MDS]
...
.panel[.panel-name[Binarios-NMDS]
